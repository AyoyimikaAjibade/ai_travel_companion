...
def call_gemini(user_message: str, current_slots: Optional[Slots]) -> dict:    
    ...
    prompt = (
        ...
        "FILLING RULES:\n"
            ...
            "9) **reply**:\n"
            "   • If there is any item in the `missing`, fill reply field to request filling the missing field in **everyday language ONE BY ONE. DO NOT MENTION ALL MISSING FIELDS AT ONCE.**. Don't use slot field names or IATA codes. \n"
